...
MODULE = SourceFileLoader("erxiao_spider", str(ROOT / "二小.py")).load_module()
Spider = MODULE.Spider


class TestErXiaoSpider(unittest.TestCase):
    def setUp(self):
    ...
    def test_build_pan_lines_deduplicates_and_sorts_supported_links(self):
        ...
        self.assertEqual(
            ...
            [
                ("baidu#二小", "百度资源$https://pan.baidu.com/s/b1"),
                ("quark#二小", "夸克资源$https://pan.quark.cn/s/q1"),
            ],
        )
    ...
    def test_detail_content_builds_pan_play_fields(self, mock_request_html):
        ...
        self.assertEqual(vod["vod_play_from"], "baidu#二小$$$quark#二小")
        self.assertEqual(
            vod["vod_play_url"],
    ...
    def test_player_content_passthroughs_supported_pan_urls(self):
        self.assertEqual(
            self.spider.playerContent("baidu#二小", "https://pan.baidu.com/s/demo", {}),
